...
* [**Первая половина тем**](algorithms/1/)
* [**Демоническое программирование**](algorithms/2/)
* [**СНМ, ПСД и ТЧ**](algorithms/3/)
* [**Всякие бинарные приколы с отрезками**](algorithms/4/)
* [**Бинарный лес (с рандомом и вращениями)**](algorithms/5/)
* [**Всякие бинарные приколы в небинарном лесу**](algorithms/6/)
...
* [**Лабораторная 2117 (7 в старой (нормальной) нумерации)**](algorithms/7/)
* [**Игролаба (развлекайтесь)**](algorithms/8/)
* [**Пути (не путю)**](algorithms/9/)
