...
public class IfStatement implements CStatement {
	private final CExpression expression;
	private final List<CStatement> statements;

	public IfStatement(final CExpression expression, final List<CStatement> statements) {
	...
	public String asStatement() {
		return "if" + expression.asExpression() + "{" + System.lineSeparator() + statements.stream().map(CStatement::asStatement).collect(Collectors.joining()) + "}" + System.lineSeparator();
	}

	@Override
	public String asStatement(final Map<String, CVariable> args) {
		throw new Py2CUnsupportedOperationException("compiling with arguments in IfStatement");
	}

	@Override
	public CType getType() {
		throw new Py2CUnsupportedOperationException("type of IfStatement");
	}

	@Override
	public String asExpression() {
		throw new Py2CUnsupportedOperationException("expression of IfStatement");
	}

	@Override
	public void fixTypes(final Map<String, CVariable> args) {
		throw new Py2CUnsupportedOperationException("fixing types in IfStatement");
	}
