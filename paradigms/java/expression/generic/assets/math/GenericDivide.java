...
public class GenericDivide<T> extends GenericBinaryOperator<T> {
	private final GenericOperationType<T> mode;

	public GenericDivide(final GenericExpression<T> a, final GenericExpression<T> b, final GenericOperationType<T> mode) {
		super(a, b, "/");
		this.mode = mode;
	}
