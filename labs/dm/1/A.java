...
public class A {
    ...
    private static void rel(int n, int[][] o1, int[][] o2, int[][] o3) {
        for (int i = 0; i < n; i++) {
            for (int j = 0; j < n; j++) {
                for (int k = 0; k < n; k++) {
    ...
    private static void trans(int n, int[][] o1, int[][] o2, int[] ans1, int[] ans2) {
    ...
    private static void simm(int n, int[][] o1, int[][] o2, int[] ans1, int[] ans2) {
    ...
    private static void ref(int n, int[][] o1, int[][] o2, int[] ans1, int[] ans2) {
    ...
    private static void input(Scanner in, int n, int[][] o1, int[][] o2) {
        for (int i = 0; i < n; i++) {
