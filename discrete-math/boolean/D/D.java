...
public class D {
	...
	private static int getCount(final int n, final int[][] a0, final int[][] a1, final int[][] x0, final int[][] x1, final List<String> ans, final int k0, final int k1, int count, int curr) {
		if (k1 != 0) {
			for (int i = 0; i < k1; i++) {
				for (int j = 1; j < n; j++) {
					if (x1[i][j - 1] == 0) {
