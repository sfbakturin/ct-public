...
public class Markdown {
	...
	private final static Map<String, LibraryPairs> MARKDOWN_LIBRARY;
	private final static Map<String, String> SPECIAL_LIBRARY;
	private final static HashSet<String> MARKDOWN_ELEMENTS = new HashSet<>();
	...
	private final static class LibraryPairs {
		private final String start;
		private final String end;

		public LibraryPairs(final String start, final String end) {
			this.start = start;
			this.end = end;
		}
